...
PC increments by 2. `Rd`/`Rn` are R0-R3 and `An` is A0-A3. Branches and BL use
...
CMP Rd,Rn
BL label                  BR/BEQ/BNE/BLT/BGE/BLTU/BGEU label
...
Encoding anchors: `LI=0x1`, `ADD=0x3`, `SUB=0x4`, `BL=0x5`, branches=`0x6`,
